...
namespace Gaskellgames
{
    public class GaskellgamesHub : GGEditorWindow
    {
        ...
        private void HandleDownloadedPackages()
        {
            ...
            string PoolingSystem = "Assets/Gaskellgames/Pooling System/Editor/Icons/Logo_PoolingSystem.png";
            Texture logo_PoolingSystem = (Texture)AssetDatabase.LoadAssetAtPath(PoolingSystem, typeof(Texture));
            if(logo_PoolingSystem != null)
            {
                GUIContent label_PoolingSystem = new GUIContent(logo_PoolingSystem, "Pooling System");
                GUILayout.Box(label_PoolingSystem, GUILayout.Width(logoSize), GUILayout.Height(logoSize));
            }
